...
DORA_BUILD_DATE := $(DORA_DATE_HOUR)$(DORA_DATE_MINUTE)-$(DORA_DATE_DAY)$(DORA_DATE_MONTH)$(DORA_DATE_YEAR)

DORA_PLATFORM_VERSION := 12.0

DORA_VERSION := DoraemonOS-V$(DORAUI_VERSION)-A$(DORA_PLATFORM_VERSION)-$(DORA_BUILD)-$(DORA_BUILD_DATE)-$(DORA_BUILD_TYPE)
DORA_VERSION_PROP := 12
